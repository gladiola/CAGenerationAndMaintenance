...
## परिनियोजन योजना (स्क्रिप्ट चलाने से पहले इसे भरें)

नीचे दिए गए चरण चलाने से पहले अपने परिनियोजन मान तैयार करें:

- CA कहाँ होगी?  
  default: `/root/ca`  
  वास्तविक:

- संगठन क्या है और वह कहाँ है?  
...
- प्रोजेक्ट का वर्ज़न दिनांक क्या है?  
  default: `01012027`  
  वास्तविक:
...
- क्लाइंट उपयोगकर्ता(ओं) का ईमेल पता क्या है?  
  default: `user@example.com`  
  वास्तविक:

- ट्रांसफ़र के लिए USB ड्राइव कहाँ है?  
  default: `/dev/sd1i`  
  वास्तविक:
