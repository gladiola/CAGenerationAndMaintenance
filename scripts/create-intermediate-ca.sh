...
#   DATE_SUFFIX    Date stamp appended to file names (e.g. 01JAN2027).
...
#
# Example:
#   doas sh create-intermediate-ca.sh MY-PROJECT 01JAN2027 /root/ca \
#     "/C=US/ST=Massachusetts/L=Cambridge/O=My Org/CN=My Org Intermediate CA MY-PROJECT 01JAN2027"
